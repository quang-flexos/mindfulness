const quotes = [
  ...
  { "quote": "Time isnâ€™t precious at all, because it is an illusion. What you perceive as precious is not time but the one point that is out of time: the Now. That is precious indeed. The more you are focused on time â€” past and future â€” the more you miss the Now, the most precious thing there is.", "author": "Eckhart Tolle" },
  ...
  { "quote": "You canâ€™t stop the waves, but you can learn to surf.", "author": "Jon Kabat-Zinn" },
  ...
  { "quote": "Best advice ever received was from one of my meditation teachers at the monastery: â€˜Be present, be patient, be gentle, be kindâ€¦everything else will take care of itself.â€™", "author": "Andy Puddicombe" },
  { "quote": "If itâ€™s out of your hands, it deserves freedom from your mind too.", "author": "Ivan Nuru" },
  ...
  // Continuing from the previous sets...
    ...
    { "quote": "In todayâ€™s rush, we all think too much - seek too much - want too much - and forget about the joy of just being.", "author": "Eckhart Tolle" },
    ...
    { "quote": "There is nothing more important to true growth than realizing that you are not the voice of the mindâ€”you are the one who hears it.", "author": "Michael A. Singer" },
    ...
    { "quote": "Donâ€™t believe everything you think. Thoughts are just that â€“ thoughts.", "author": "Allan Lokos" },
    ...
    { "quote": "To be beautiful means to be yourself. You donâ€™t need to be accepted by others. You need to accept yourself.", "author": "Thich Nhat Hanh" },
  ...
  { "quote": "A mind is like a parachute. It doesnâ€™t work if it isnâ€™t open.", "author": "Frank Zappa" },
  ...
  { "quote": "An anxious mind is an unproductive mind that doesnâ€™t inspire the best in others. A top priority for mindful leaders is cultivating peace of mind.", "author": "Matt Tenney" },
  ...
  { "quote": "Be happy in the moment, thatâ€™s enough. Each moment is all we need, not more.", "author": "Mother Teresa" },
  ...
  { "quote": "Weâ€™re so busy watching out for whatâ€™s just ahead of us that we donâ€™t take time to enjoy where we are.", "author": "Bill Watterson" },
  { "quote": "Meditation practice isnâ€™t about trying to throw ourselves away and become something better. Itâ€™s about befriending who we are already.", "author": "Pema Chodron" },
